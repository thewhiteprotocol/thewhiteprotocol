...
export default function PsolV2FlowVisualizer() {
  const base = useMemo(() => ({
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="min-w-[300px]">
              <div className="text-lg font-bold text-slate-700">pSOL v2 Privacy Protocol Flow</div>
                          ...
                          {mode === "privacy" && (
                            ...
                            >
                              ...
                              <g transform={`translate(${W/2}, 60)`}>
                                <text textAnchor="middle" fill={COLORS.ink} fontFamily={MONO} fontSize={20} fontWeight="800">pSOL v2 SHIELDED POOL</text>
