    ...
    <section id="links" className="py-24 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-500">Connect with the White Protocol community</p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-block p-6 bg-[#E0E5EC] rounded-2xl shadow-[inset_6px_6px_12px_#b8b9be,inset_-6px_-6px_12px_#ffffff]">
            <p className="text-sm text-slate-500">Built with love for cross-chain privacy</p>
