...
const docs = [
  {
    ...
    content: "The White Protocol enables private transactions on Solana using zero-knowledge proofs. Connect your wallet, deposit tokens into the privacy pool, and withdraw privately to any address. This is a 100% open source protocol.",
  },
  {
    icon: Lock,
