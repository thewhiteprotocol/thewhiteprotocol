  ...
  return (
    <section id="overview" className="min-h-screen flex items-center justify-center pt-16 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl md:text-2xl text-transparent bg-clip-text bg-gradient-to-r from-[#9945FF] to-[#14F195] font-semibold mb-6">Private Liquidity on Solana & Base</p>
        <p className="text-lg text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
          A multi-chain privacy pool protocol enabling private transfers with Groth16 zero-knowledge proofs on Solana and Base. Deposit tokens, transfer privately, and withdraw securely.
        </p>
