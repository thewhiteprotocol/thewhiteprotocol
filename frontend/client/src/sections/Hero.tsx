      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex justify-center mb-6">
          <div className="px-4 py-2 bg-white/[0.04] rounded-full border border-white/[0.06] flex items-center gap-2 backdrop-blur-sm">
            ...
            <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Live on Solana Devnet + Base Sepolia</span>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          <a href={import.meta.env.VITE_APP_URL || "https://app.thewhiteprotocol.com"} className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-2xl hover:shadow-[0_0_30px_rgba(0,200,240,0.3)] active:scale-95 transition-all duration-300 flex items-center gap-2 text-white font-bold">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-lg mx-auto">
          ...
          <div className="p-4 bg-black/20 rounded-2xl border border-white/[0.04] backdrop-blur-sm">
            <p className="text-xs text-slate-500 font-bold uppercase tracking-wider mb-1">Chains</p>
