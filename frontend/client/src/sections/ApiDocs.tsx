      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-500 mb-4">
            RESTful API for The White Protocol operations. Currently supports Solana and Base networks.
          </p>
        ...
        <div className="mt-12 p-6 bg-[#E0E5EC] rounded-2xl shadow-[8px_8px_16px_#b8b9be,-8px_-8px_16px_#ffffff]">
          <h3 className="text-lg font-bold text-slate-700 mb-4">Current Pool Configuration</h3>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div className="p-3 bg-[#E0E5EC] rounded-xl shadow-[inset_2px_2px_4px_#b8b9be,inset_-2px_-2px_4px_#ffffff]">
                <p className="text-xs text-slate-400 font-bold uppercase">White Protocol Contract</p>
                <code className="text-xs text-slate-600 break-all">0xCE959493cf6F15314b4B9eEbb28369716341e7FE</code>
              </div>
              <div className="p-3 bg-[#E0E5EC] rounded-xl shadow-[inset_2px_2px_4px_#b8b9be,inset_-2px_-2px_4px_#ffffff]">
                <p className="text-xs text-slate-400 font-bold uppercase">Asset Registry</p>
                <code className="text-xs text-slate-600 break-all">0x87319Da4558FcBD4f3475cFECc468ee4D736D3ea</code>
              </div>
            </div>
          </div>
        </div>
