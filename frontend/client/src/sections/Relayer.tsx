      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {relayerFeatures.map((f) => (
            ...
            >
              <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-cyan-500/10 transition-transform group-hover:scale-110">
        ...
        <div className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            ...
            <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-black/20 border border-white/[0.06]">
              {health === "ok" ? (
                <>
                ...
                <>
                  ...
                  <span className="text-sm font-bold text-zinc-400">Checking...</span>
                </>
              )}
            </div>
          </div>
          ...
          <div className="space-y-3">
            {endpoints.map((ep) => (
              <div
                key={ep.path}
                className="flex flex-col sm:flex-row sm:items-center gap-3 p-4 rounded-xl bg-black/20 border border-white/[0.06]"
              >
                <span
          ...
          <div className="mt-6 p-4 rounded-xl bg-black/20 border border-white/[0.06]">
            <p className="text-sm text-zinc-400">
              <span className="font-bold text-white">Fee Structure:</span> 50 bps (0.5%) relayer fee on withdrawals. 
