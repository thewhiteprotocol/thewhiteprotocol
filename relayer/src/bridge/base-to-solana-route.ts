...
export const SOLANA_DEVNET_SIGNER_SET_VERSION = 3;
export const SOLANA_DEVNET_SIGNER_SET_V3 =
  'BwtnXeqyZZFoLbjKxuYpzY61zNgmtEQoEqi4DnrdfQT8';
...
export const BASE_SEPOLIA_TO_SOLANA_DEVNET_ROUTE: BridgeRouteConfig = {
  ...
  solanaDestination: {
    ...
    signerSetVersion: SOLANA_DEVNET_SIGNER_SET_VERSION,
    signerSetPda: SOLANA_DEVNET_SIGNER_SET_V3,
