...
function publicJobSummary(job: OperatorJobEntry): Record<string, unknown> {
  return {
    ...
    leafIndexEvidencePath: job.leafIndexEvidencePath || null,
    leafIndexEvidenceSha256: job.leafIndexEvidenceSha256 || null,
    leafIndexEvidenceSource: job.leafIndexEvidenceSource || null,
    leafIndex: job.leafIndex ?? null,
