...
const CONFIG = {
  ...
  // Circuit paths
  DEPOSIT_WASM: path.join(__dirname, "../../circuits/deposit/build/deposit_js/deposit.wasm"),
  DEPOSIT_ZKEY: path.join(__dirname, "../../circuits/deposit/build/deposit.zkey"),
  WITHDRAW_WASM: path.join(__dirname, "../../circuits/withdraw/build/withdraw_js/withdraw.wasm"),
  WITHDRAW_ZKEY: path.join(__dirname, "../../circuits/withdraw/build/withdraw.zkey"),
  MERKLE_BATCH_WASM: path.join(__dirname, "../../circuits/merkle_batch_update/build/merkle_batch_update_js/merkle_batch_update.wasm"),
  MERKLE_BATCH_ZKEY: path.join(__dirname, "../../circuits/merkle_batch_update/build/merkle_batch_update.zkey"),
};
