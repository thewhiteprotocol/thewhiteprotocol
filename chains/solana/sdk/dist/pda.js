 ...
 */
export function findPoolConfigPda(programId, authority) {
    return PublicKey.findProgramAddressSync([POOL_SEED, authority.toBuffer()], programId);
}
/**
 ...
 * @returns [PDA address, bump seed]
 */
export function findMerkleTreePda(programId, poolConfig) {
    return PublicKey.findProgramAddressSync([MERKLE_TREE_SEED, poolConfig.toBuffer()], programId);
}
/**
 ...
 * @returns [PDA address, bump seed]
 */
export function findAssetVaultPda(programId, poolConfig, assetId) {
    if (assetId.length !== 32) {
        throw new Error('Asset ID must be 32 bytes');
    }
    return PublicKey.findProgramAddressSync([VAULT_SEED, poolConfig.toBuffer(), Buffer.from(assetId)], programId);
}
/**
 ...
 * @returns [PDA address, bump seed]
 */
export function findVerificationKeyPda(programId, poolConfig, proofType) {
    const seed = proofTypeSeed(proofType);
    return PublicKey.findProgramAddressSync([seed, poolConfig.toBuffer()], programId);
}
/**
 ...
 * @returns [PDA address, bump seed]
 */
export function findSpentNullifierPda(programId, poolConfig, nullifierHash) {
    if (nullifierHash.length !== 32) {
        throw new Error('Nullifier hash must be 32 bytes');
    }
    return PublicKey.findProgramAddressSync([NULLIFIER_SEED, poolConfig.toBuffer(), Buffer.from(nullifierHash)], programId);
}
/**
 ...
 * @returns [PDA address, bump seed]
 */
export function findRelayerRegistryPda(programId, poolConfig) {
    return PublicKey.findProgramAddressSync([RELAYER_REGISTRY_SEED, poolConfig.toBuffer()], programId);
}
/**
 ...
 * @returns [PDA address, bump seed]
 */
export function findPendingBufferPda(programId, poolConfig) {
    return PublicKey.findProgramAddressSync([PENDING_SEED, poolConfig.toBuffer()], programId);
}
/**
 ...
 * @returns [PDA address, bump seed]
 */
export function findRelayerNodePda(programId, registry, operator) {
    return PublicKey.findProgramAddressSync([RELAYER_SEED, registry.toBuffer(), operator.toBuffer()], programId);
}
/**
 ...
 * @returns [PDA address, bump seed]
 */
export function findComplianceConfigPda(programId, poolConfig) {
    return PublicKey.findProgramAddressSync([COMPLIANCE_SEED, poolConfig.toBuffer()], programId);
}
// ============================================================================
// ASSET ID HELPERS
// ============================================================================
 ...
 */
export function computeAssetId(mint) {
 ...
 */
export function derivePoolPdas(programId, authority) {
 ...
 */
export function deriveAssetVaultPdas(programId, poolConfig, assetIds) {
 ...
 */
export function deriveVerificationKeyPdas(programId, poolConfig) {
    return {
