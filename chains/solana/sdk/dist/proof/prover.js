 ...
 */
export function pubkeyToScalar(pubkey) {
 ...
 */
export async function verifyProofLocally(proofType, proof, publicSignals, vkeyPath) {
 ...
 */
export async function exportVerificationKey(zkeyPath) {
