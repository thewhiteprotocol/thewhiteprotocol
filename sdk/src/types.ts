 ...
 */
export function proofTypeSeed(proofType: ProofType): Uint8Array {
  const seeds: Record<ProofType, string> = {
 ...
 */
export enum ShieldedActionType {
 ...
 */
export function isValidProofLength(proofData: Uint8Array): boolean {
